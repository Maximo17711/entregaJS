...
console.log
("la propiedad es una " + Casa1.Nombre)
console.log
("usted quiere " + Casa1.Accion)
console.log
("La localidad de su "+ Casa1.Nombre +" se encuetra en " + Casa1.Localidad)
console.log
("usted " + Casa1.Garantia[1] + " necesita garantia")
console.log
("La propiedad tiee un valor de $" + Casa1.Valor + " dolares")
console.log
("Cuenta con unos " + Casa1.MetrosCuadrados)
...
function NCuotas(){
    let DivisionCuotas = parseInt(prompt("puede hacerlo hasta 78 cuotas, en cuantas las va a hacer?"));
